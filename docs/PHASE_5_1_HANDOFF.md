...
- The verified pre-Phase-5.1 Git baseline was `6d85dc2`. Phase 5.2 Camera Preset Library was subsequently committed as `97c45d9`, and Phase 5.3 transfer as `5c6a8ad`; Phase 5.4 Project New/Open/Save changes are separate and currently live in the working tree.
